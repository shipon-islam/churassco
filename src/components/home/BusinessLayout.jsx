      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        {businessApi?.map((businessItem) => (
          ...
          >
                  ...
                  >
                    <div>
                      <Image
                        src={item}
                        alt={item}
                        className=" object-cover w-full h-full max-h-[701px]"
                      />
                    </div>
                  </SwiperSlide>
                );
            ...
            <div className="absolute top-0 left-0 z-10 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-brown w-full h-full p-14">
              <h2 className="lowercase text-4xl font-bernier">
                {businessItem.title}
              </h2>
              <p className="mt-9 mb-20">{businessItem.description}</p>
