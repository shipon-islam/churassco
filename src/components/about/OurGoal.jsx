        ...
        <div className="grid grid-cols-[1.5fr_1fr] md:grid-cols-2 md:gap-x-4">
          <div className="relative">
            <Image
              ...
              height={1170}
              alt="img"
              className="w-full rounded-tr-[40%] rounded-bl-[40%] h-[320px] xxs:h-[433px] sm:h-[700px] lg:h-[850px] xl:h-[950px] object-cover"
            />
          </div>
          <div className="text-right flex flex-col">
            ...
            <div className="flex flex-col justify-center md:justify-end h-full relative right-10 md:right-0">
              ...
              />
              <h5 className="text-xl xxs:text-2xl md:text-4xl uppercase font-monthoers text-orange flex flex-col -rotate-10 absolute -bottom-5 xxs:bottom-5 md:-bottom-5 right-10 sm:right-30 md:right-10 xl:right-58 z-10 text-nowrap">
