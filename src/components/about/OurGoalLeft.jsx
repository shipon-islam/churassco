    ...
    <div className="bg-body">
      <div className="container grid grid-cols-2 gap-x-4 py-20">
        <div className="flex flex-col">
          <h4 className="text-5xl font-bernier w-58">Our goals & history</h4>
          <p className="mt-8">
          ...
          <div className="flex flex-col justify-end items-end h-full relative">
            <Image
              ...
              className="h-fit"
            />
            <h5 className="text-4xl uppercase font-monthoers text-orange flex flex-col -rotate-10 absolute -bottom-5 -left-18 xl:left-32">
